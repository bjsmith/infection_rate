...
Our risk categories are "COVID-free", "Level 1", "Level 2", "Level 3", and "Level 4". For Level 4 countries, we propose continuing existing restrictions and adding a pre-departure PCR test. For all others, from COVID-free to Level 3 locations, some level of non-residents could be allowed in without excessive risk.

The overall rating for `r locname` is `r params$location_info$PrevalenceRating`.
