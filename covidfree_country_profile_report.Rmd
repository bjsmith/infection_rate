...
According to the Ministry of Health in `r locname`, there are no cases of COVID-19 in `r locname`. The border is very closely monitored and we can have a high degree of confidence that while current border control practices remain intact,  `r locname` will remain COVID free.
